...
export const mapToSupported = (raw?: string): SupportedLocale => {
  if (!raw) return "en-US";
  ...
  if (s.startsWith("es-419")) return "es-419";
  if (s.startsWith("es-mx")) return "es-419";
  if (s.startsWith("es-ar")) return "es-419";
  if (s.startsWith("es-cl")) return "es-419";
  if (s.startsWith("es-co")) return "es-419";
  if (s.startsWith("es-pe")) return "es-419";
  if (s.startsWith("es-ve")) return "es-419";
