...
Object.defineProperty(exports, "AppNavigator", { enumerable: true, get: function () { return AppNavigator_1.default; } });
// и дополнительно — named-экспорты из файла (если они есть):
__exportStar(require("./lib/navigation/AppNavigator"), exports);
// i18n — если там именно функции/константы (не только типы), ок:
