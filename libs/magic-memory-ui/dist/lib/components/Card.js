...
const MemoryCard = memo(({ item, onPress, getCardSize, disabled = false, isHinted = false, style, backImage, frontImage, }) => {
    ...
    return (_jsx(Animated.View, { style: { opacity: cardOpacity }, children: _jsxs(TouchableOpacity, { style: [styles.card, { width: cardSize, height: cardSize }, style], onPress: () => !disabled && onPress(item.id), disabled: disabled, activeOpacity: 1, children: [item.isMatched && (_jsx(Animated.View, { pointerEvents: "none", style: {
                        position: "absolute",
                        top: 0,
                        left: 0,
                        right: 0,
                        ...
                        styles.cardSide,
                        {
                            ...
                            zIndex: 0,
                    ...
                    ], children: [!item.isMatched && (_jsx(Animated.View, { pointerEvents: "none", style: {
                                position: "absolute",
                                top: 0,
                                left: 0,
                                right: 0,
                                ...
                                borderWidth: 4,
                                zIndex: 2,
                            } })), _jsx(Image, { source: imageSource, style: [styles.cardImage, { width: cardSize, height: cardSize }], resizeMode: "contain" })] }), isHinted && !item.isFlipped && !item.isMatched && (_jsx(Animated.View, { style: {
                        position: "absolute",
                        top: 0,
                        left: 0,
                        right: 0,
                        ...
                        styles.cardBackFace,
                        {
                            ...
                            zIndex: 0,
                                ...
                                borderWidth: 4,
                                zIndex: 2,
                            } })), _jsx(Image, { source: resolvedBackImage, style: [styles.cardImage, { width: cardSize, height: cardSize }], resizeMode: "contain" }), _jsx(Animated.View, { style: [styles.hintOverlay, { opacity: hintOpacity }], children: _jsx(Image, { source: resolvedBackImage, style: [
                                    styles.cardImage,
